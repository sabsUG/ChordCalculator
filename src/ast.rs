...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Accidental { Sharp, Flat }   // '#', 'b'
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Qual { Minus, Plus, LowerO, Five, One } // -, +, o, 5, 1

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Ext { Nine, Eleven, Thirteen } // 9, 11, 13
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Sus { Sus2, Sus4, Sus24 }

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Omit { No3, No5, No35 }